import { 
  ...
  umkms, type Umkm, type InsertUmkm,
  villageProfile, type VillageProfile, type InsertVillageProfile
} from "@shared/schema";
...
export interface IStorage {
  ...
  updateVillageProfile(id: number, profile: Partial<InsertVillageProfile>): Promise<VillageProfile | undefined>;
}
...
export class MemStorage implements IStorage {
  ...
  async getUmkmsByCategoryId(categoryId: number): Promise<Umkm[]> {
    return Array.from(this.umkms.values()).filter(umkm => umkm.categoryId === categoryId);
  }
  ...
  async createVillageProfile(insertProfile: InsertVillageProfile): Promise<VillageProfile> {
  ...
  private initializeData() {
    ...
    const umkmsData: InsertUmkm[] = [
      {
        ...
        description: "Memproduksi berbagai kerajinan dari bambu berkualitas tinggi, termasuk keranjang, vas, dan furnitur mini.",
        imageUrl: "https://images.unsplash.com/photo-1604849329107-1a24669fa440",
      ...
      },
      {
        ...
        description: "Menyajikan berbagai makanan dan kue tradisional yang dibuat dari bahan-bahan lokal berkualitas.",
        imageUrl: "https://images.unsplash.com/photo-1619526881542-c81baff85fa4",
      ...
      },
      {
        ...
        description: "Menghasilkan sayuran dan buah-buahan organik segar langsung dari kebun tanpa pestisida kimia.",
      ...
      },
      {
        ...
        description: "Memproduksi kain batik dengan pewarna alami dari tumbuhan lokal dengan motif khas desa.",
        imageUrl: "https://pixabay.com/get/gf3689bb6f45fd018d16b64086251e3dc3aa8df4a487dd070a3c62a1f5a833a34b625a5bb13ebba240f441247c256194576bcc2514f03fa43a7e2e722172fc9d6_1280.jpg",
      ...
      },
      {
        ...
        description: "Menawarkan biji kopi lokal yang ditanam di ketinggian optimal dan diolah dengan metode tradisional.",
        imageUrl: "https://pixabay.com/get/g8a03d6b6c36fab89ec7a9efb2df5cf24e9d9418ae670839855c458d99300fe8d8f771601e26ada652e4f3e6b710bda3aaa28cbad340a2ffaaee855c3be76d76_1280.jpg",
        location: "Dusun Makmur",
      ...
      },
      {
        ...
        description: "Menyediakan madu murni yang diambil langsung dari hutan desa dengan kualitas premium.",
    ...
    const villageProfileData: InsertVillageProfile = {
      ...
      history: "Desa Sejahtera memiliki sejarah panjang sejak tahun 1945. Didirikan oleh para pejuang kemerdekaan, desa ini telah berkembang menjadi pusat ekonomi dan budaya di kawasan ini.",
      vision: "Menjadikan Desa Sejahtera sebagai desa mandiri dan berkelanjutan melalui pemberdayaan ekonomi lokal dan pelestarian budaya.",
      mission: [
