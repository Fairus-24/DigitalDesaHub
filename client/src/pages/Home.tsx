  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Website Desa Sejahtera menyediakan informasi desa dan mendukung pemberdayaan UMKM lokal. Temukan produk-produk berkualitas dan lokasi usaha mikro di desa kami." />
        <meta property="og:title" content="Desa Sejahtera - Pusat Informasi dan UMKM Lokal" />
        <meta property="og:description" content="Website Desa Sejahtera menyediakan informasi desa dan mendukung pemberdayaan UMKM lokal. Temukan produk-produk berkualitas dan lokasi usaha mikro di desa kami." />
